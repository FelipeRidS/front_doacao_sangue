...
class ConsultarDadosScreen extends StatelessWidget {
  const ConsultarDadosScreen({super.key});
        ...
        child: ListView(
          children: [
            const DescricaoComponent(
                ...
                subtitulo:
                    "Escolha uma das tabelas abaixo para Consultar dados..."),
            ...List.generate(tablesButtonData.length, (index) {
              ...
              return MainButton(
                ...
                redirect: (context) =>
                    buttonData.redirect(context, "consultarDados"),
              );
            })
          ],
        ),
